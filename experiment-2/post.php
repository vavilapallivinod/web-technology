...
<div class="topnav">
  ...
  <?php
        ...
        {
            echo "<br><br>";
            echo "<div  style='border: 3px solid skyblue; border-style:double ;margin-left:30%; margin-right:38%; padding-top: 10px; border-radius:10px'>";
            ...
            echo "<input style='background-color:palepink; color:darkred; border: none; padding: 10px 20px; border-radius: 40px; font-size: 16px;' type='submit' value='&#10084;&nbsp;" . $row["likes"] . "' /></th>";
            echo "</form>";
            echo "<br>";
            ...
            echo "<th><input type='submit' name='submit' value='comment' style='height:45px; background-color:aquamarine; color:black; border: none; padding: 10px 20px; border-radius: 40px; font-size: 16px;'></th></tr></table>";
            echo "</form>"; 
            ...
            if ($con->connect_error) {
              ...
              echo "<h2 style='color:white';>Comments:</h2>";
              while($comm=mysqli_fetch_array($res)){
                echo "<p style='color:beige';>".$comm['email']." commented :".$comm['comment']."</p>";
              }
            echo "</div>";   
        }
